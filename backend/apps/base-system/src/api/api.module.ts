...
import { MyInfraModule } from '@app/base-system/infra/bounded-contexts/my/my.infra.module';
...
import { Controllers as MyRest } from './my/rest';
import { Controllers as MyHomeRest } from './my-home/rest';
