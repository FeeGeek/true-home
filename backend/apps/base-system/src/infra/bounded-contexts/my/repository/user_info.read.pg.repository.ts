...
import { SysUser } from '@app/base-system/lib/bounded-contexts/my/domain/entities/sys-user.entity';
import { UserInfoRepoPort } from '@app/base-system/lib/bounded-contexts/my/domain/ports/user-info.repo.port';
